...
class FilesCommandSet extends pip_services3_commons_node_1.CommandSet {
    constructor(logic) {
        super();
        this._logic = logic;
    ...
    makeGetFilesByFilterCommand() {
        return new pip_services3_commons_node_2.Command("get_files_by_filter", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeGetFilesByIdsCommand() {
        return new pip_services3_commons_node_2.Command("get_files_by_ids", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("file_ids", new pip_services3_commons_node_6.ArraySchema(pip_services3_commons_node_7.TypeCode.String)), (correlationId, args, callback) => {
            let fileIds = args.get("file_id");
            this._logic.getFilesByIds(correlationId, fileIds, callback);
        });
    }
    makeGetFileByIdCommand() {
        return new pip_services3_commons_node_2.Command("get_file_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("file_id", pip_services3_commons_node_7.TypeCode.String), (correlationId, args, callback) => {
            let fileId = args.getAsNullableString("file_id");
            this._logic.getFileById(correlationId, fileId, callback);
        });
    }
    makeCreateFileCommand() {
        return new pip_services3_commons_node_2.Command("create_file", new pip_services3_commons_node_5.ObjectSchema(true)
    ...
    makeUpdateFileCommand() {
        return new pip_services3_commons_node_2.Command("update_file", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("file", new FileV1Schema_1.FileV1Schema()), (correlationId, args, callback) => {
            let file = args.get("file");
    ...
    makeDeleteFileByIdCommand() {
        return new pip_services3_commons_node_2.Command("delete_file_by_id", new pip_services3_commons_node_5.ObjectSchema(true)
            .withRequiredProperty("file_id", pip_services3_commons_node_7.TypeCode.String), (correlationId, args, callback) => {
            let fileId = args.getAsNullableString("file_id");
