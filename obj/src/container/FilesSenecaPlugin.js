...
class FilesSenecaPlugin extends pip_services_seneca_node_1.SenecaPlugin {
    ...
    static createReferences(seneca, options) {
        ...
        if (persistenceType == 'mongodb')
            ...
            throw new pip_services_commons_node_4.ConfigException(null, 'WRONG_PERSISTENCE_TYPE', 'Unrecognized info persistence type: ' + persistenceType);
