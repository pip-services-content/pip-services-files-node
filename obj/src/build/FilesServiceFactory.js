...
class FilesServiceFactory extends pip_services_commons_node_1.Factory {
    constructor() {
        super();
...
FilesServiceFactory.Descriptor = new pip_services_commons_node_2.Descriptor("pip-services-files", "factory", "default", "default", "1.0");
FilesServiceFactory.MemoryPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-files", "persistence", "memory", "*", "1.0");
FilesServiceFactory.FilePersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-files", "persistence", "file", "*", "1.0");
FilesServiceFactory.MongoDbPersistenceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-files", "persistence", "mongodb", "*", "1.0");
FilesServiceFactory.ControllerDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-files", "controller", "default", "*", "1.0");
FilesServiceFactory.SenecaServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-files", "service", "seneca", "*", "1.0");
FilesServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_2.Descriptor("pip-services-files", "service", "http", "*", "1.0");
