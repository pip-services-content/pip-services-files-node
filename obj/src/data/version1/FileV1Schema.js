...
class FileV1Schema extends pip_services3_commons_node_1.ObjectSchema {
    constructor() {
        super();
        /* Identification */
        ...
        this.withOptionalProperty('content_id', pip_services3_commons_node_2.TypeCode.String);
        this.withOptionalProperty('content_uri', pip_services3_commons_node_2.TypeCode.String);
        this.withOptionalProperty('thumbnail_id', pip_services3_commons_node_2.TypeCode.String);
        this.withOptionalProperty('thumbnail_uri', pip_services3_commons_node_2.TypeCode.String);
        this.withOptionalProperty('create_time', null); //TypeCode.DateTime);
        this.withOptionalProperty('expire_time', null); //TypeCode.DateTime);
        this.withOptionalProperty('attributes', pip_services3_commons_node_2.TypeCode.Map);
        /* Custom fields */
